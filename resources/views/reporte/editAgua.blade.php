		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					<div class="panel-heading"> Nombre de indicadoooor: <br>  {{$indicadorAgua->nombre}}  </div>
						...
						<script type="text/javascript">
                            ...
                            function drawChart() {
                                ...
                                var data = google.visualization.arrayToDataTable([
                                    ...
                                    ['Tareas', 'Progreso'],
										@foreach ($tareaAgua as $tarea)
										@if($indicadorAgua->id_indicadorAgua == $tarea->indicadorAgua_id_indicador)
